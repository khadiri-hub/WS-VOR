<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Compagnies.aspx.cs" Inherits="VOR.Front.Web.Pages.Evenement.Compagnies" %>
...
<asp:Content ID="content1" ContentPlaceHolderID="HeadContent" runat="server">
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        <script type="text/javascript">
            ...
            function rebindGrid() {
                var masterTable = $find("<%= this.gridCompagnie.ClientID %>").get_masterTableView();
                masterTable.rebind();
            }
        </script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="padding: 10px;height:610px">
        <telerik:RadGrid ID="gridCompagnie" runat="server"
            CellSpacing="0" AllowPaging="True" GridLines="None" OnNeedDataSource="gridCompagnie_NeedDataSource" OnItemDataBound="gridCompagnie_ItemDataBound">
            <ExportSettings HideStructureColumns="true" />
            <PagerStyle Mode="NextPrevAndNumeric" AlwaysVisible="true" />
            <MasterTableView PageSize="10" AutoGenerateColumns="False" Height="100%" AllowSorting="True" NoMasterRecordsText="Aucune compagnie existante" DataKeyNames="ID" CommandItemDisplay="Top">
    ...
    <telerik:RadAjaxManagerProxy ID="AjaxManagerProxy1" runat="server">
        <AjaxSettings>
            <telerik:AjaxSetting AjaxControlID="gridCompagnie">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="gridCompagnie" LoadingPanelID="RadAjaxLoadingPanel1" />
                </UpdatedControls>
            </telerik:AjaxSetting>
        </AjaxSettings>
        <AjaxSettings>
