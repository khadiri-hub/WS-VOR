<%@ Page Language="C#" MasterPageFile="~/PopIn.Master" CodeBehind="GestionCompagnie.aspx.cs" AutoEventWireup="true" Inherits="VOR.Front.Web.Pages.Evenement.Edit.GestionCompagnie" %>
        ...
        <div class="headerSaveDelete">
            <div style="float: right">
                <asp:ImageButton ID="_btnSupprimer" ToolTip="Supprimer" runat="server" Visible="false" ImageUrl="~/Images/imagesBack/pictoTrash.png" Width="40" Height="40"
                    OnClientClick="if(confirm('Etes-vous sûr de vouloir supprimer cette compagnie?')){ loading(true); return true; } else { return false; }"
