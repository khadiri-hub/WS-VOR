<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TypeChambres.aspx.cs" Inherits="VOR.Front.Web.Pages.Evenement.TypeChambres" %>
...
<asp:Content ID="content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        <script type="text/javascript">
            ...
            function rebindGrid() {
                var masterTable = $find("<%= this.gridTypeChambre.ClientID %>").get_masterTableView();
                masterTable.rebind();
            }
        </script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="padding: 10px;height:610px">
        <telerik:RadGrid ID="gridTypeChambre" runat="server"
            CellSpacing="0" AllowPaging="True" GridLines="None" OnNeedDataSource="gridTypeChambre_NeedDataSource" OnItemDataBound="gridChambre_ItemDataBound">
            ...
            <MasterTableView PageSize="10" AutoGenerateColumns="False" Height="100%" AllowSorting="True" NoMasterRecordsText="Aucune chambre existante" DataKeyNames="ID" CommandItemDisplay="Top">
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn DataField="Code"
                        SortExpression="Code" UniqueName="Code" HeaderText="Nombre de personnes" ItemStyle-HorizontalAlign="Center" CurrentFilterFunction="Contains" ShowFilterIcon="false" AutoPostBackOnFilter="true">
                    </telerik:GridBoundColumn>
                    <telerik:GridTemplateColumn DataField="PrixRs" HeaderText="Prix Chambre" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:Label ID="_lblPrix" runat="server" />
                        </ItemTemplate>
    ...
    <telerik:RadWindowManager ID="_rwmEdit" runat="server" Modal="true"
        ...
        <Windows>
            <telerik:RadWindow ID="_rwEdit" runat="server" Width="600px" Height="400px" />
        </Windows>
    </telerik:RadWindowManager>

    <telerik:RadAjaxManagerProxy ID="AjaxManagerProxy1" runat="server">
        <AjaxSettings>
            <telerik:AjaxSetting AjaxControlID="gridTypeChambre">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="gridTypeChambre" LoadingPanelID="RadAjaxLoadingPanel1" />
                </UpdatedControls>
            </telerik:AjaxSetting>
        </AjaxSettings>
        <AjaxSettings>
