<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Agences.aspx.cs" Inherits="VOR.Front.Web.Pages.Parametrage.Agences" %>
...
<asp:Content ID="content1" ContentPlaceHolderID="HeadContent" runat="server">
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        <script type="text/javascript">
            ...
            function rebindGrid() {
                var masterTable = $find("<%= this.gridAgence.ClientID %>").get_masterTableView();
                masterTable.rebind();
            }
        </script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="padding: 10px; height:610px">
        <telerik:RadGrid ID="gridAgence" runat="server"
            CellSpacing="0" AllowPaging="True" GridLines="None" OnNeedDataSource="gridAgence_NeedDataSource" OnItemDataBound="gridAgence_ItemDataBound">
            <ExportSettings HideStructureColumns="true" />
            <PagerStyle Mode="NextPrevAndNumeric" AlwaysVisible="true" />
            <MasterTableView PageSize="10" AutoGenerateColumns="False" Height="100%" AllowSorting="True" NoMasterRecordsText="Aucune agence existante" DataKeyNames="ID" CommandItemDisplay="Top">
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn DataField="TypeAgence.Description"
                        SortExpression="TypeAgence.Description" UniqueName="TypeAgence.Description" HeaderText="Type" ItemStyle-HorizontalAlign="Center" CurrentFilterFunction="Contains" ShowFilterIcon="false" AutoPostBackOnFilter="true">
                    </telerik:GridBoundColumn>
                    ...
                    <telerik:GridBoundColumn DataField="Adresse"
                        SortExpression="Adresse" UniqueName="Adresse" HeaderText="Adresse" ItemStyle-HorizontalAlign="Center" CurrentFilterFunction="Contains" ShowFilterIcon="false" AutoPostBackOnFilter="true">
                    </telerik:GridBoundColumn>
    ...
    <telerik:RadWindowManager ID="_rwmEdit" runat="server" Modal="true" 
        ...
        <Windows>
            <telerik:RadWindow ID="_rwEdit" runat="server" Width="550px" Height="470px" />
        </Windows>
    </telerik:RadWindowManager>

    <telerik:RadAjaxManagerProxy ID="AjaxManagerProxy1" runat="server">
        <AjaxSettings>
            <telerik:AjaxSetting AjaxControlID="gridAgence">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="gridAgence" LoadingPanelID="RadAjaxLoadingPanel1" />
                </UpdatedControls>
            </telerik:AjaxSetting>
        </AjaxSettings>
        <AjaxSettings>
