<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="HotelsUC.ascx.cs"
    Inherits="VOR.Front.Web.UserControls.Evenement.HotelsUC" %>
...
<div>
    <telerik:RadAjaxPanel runat="server" ID="RadAjaxPanel1">
        <div style="float: left; height: 180px; width: 240px;">
            <h4 style="background-color: #e1e1e1; padding: 4px; width: 205px;">Hôtels</h4>
            ...
            <telerik:RadListBox runat="server" ID="_radListBoxSource" height="110px" Width="100%" style="top: -10px"
                ...
                <itemtemplate>
                    <asp:Label ID="_lblHotelSource" runat="server"  ><%# DataBinder.Eval(Container, "Text")%></asp:Label>                                
                </itemtemplate>
            </telerik:RadListBox>
        </div>
        <div style="float: left; height: 180px; width: 212px; margin-left: 4px;">
            <h4 style="background-color: #e1e1e1; padding: 4px;">Hôtels sélectionnés</h4>
            <div style="height: 110px; width: 100%;">
                <telerik:RadListBox ID="_radListBoxDestination" runat="server" Height="100%" Width="100%" style="top: -10px"
                    ...
                    <itemtemplate>
                        <asp:Label ID="_lblHotelDestination" runat="server"><%# DataBinder.Eval(Container, "Text")%></asp:Label>
                    </itemtemplate>
                </telerik:RadListBox>
            </div>
        </div>
