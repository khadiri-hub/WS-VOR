<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CommercialUC.ascx.cs"
    Inherits="VOR.Front.Web.UserControls.Pelerin.CommercialUC" %>
...
<div>
    <telerik:RadAjaxPanel runat="server" ID="RadAjaxPanel1">
        <div style="float: left; height: 152px; width: 240px;">
            <h4 style="background-color: #e1e1e1; padding: 4px; width: 205px;">Commercial</h4>
        ...
        <div style="float: left; height: 152px; width: 212px; margin-left: 4px;">
            <h4 style="background-color: #e1e1e1; padding: 4px;">Commercial sélectionné</h4>
